...
public class TripServiceImpl implements TripService {
    ...
    public TripResponse createTrip(String userId, CreateTripRequest request) {
        ...
        // Publish AFTER_COMMIT (publisher implementation guarantees AFTER_COMMIT)
    ...
    public TripResponse updateStops(String userId, String tripId, UpdateTripStopsRequest request) {
        ...
        if (!removeIds.isEmpty()) {
            ...
            // Publish AFTER_COMMIT with removed stop ids
        ...
        if (!addDtos.isEmpty()) {
            ...
            // Publish AFTER_COMMIT with created stop ids (UUID strings generated by domain)
